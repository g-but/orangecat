...
export function SimpleChatbot() {
  ...
  if (!isOpen) {
    return (
      <button
        ...
        className="hidden md:flex fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 shadow-lg items-center justify-center text-white transition-all hover:scale-110"
  ...
  return (
    <div
      ref={chatRef}
      className="hidden md:flex fixed bottom-6 right-6 z-50 w-96 bg-white rounded-2xl shadow-2xl border border-gray-200 flex-col"
    >
      {/* Header */}
