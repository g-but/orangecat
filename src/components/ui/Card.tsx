...
export function Card({ children, className, variant = 'default', ...props }: CardProps) {
  const variants = {
    default:
      'bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-lg transition-all duration-300',
    elevated: 'bg-white rounded-2xl border-0 shadow-lg hover:shadow-xl transition-all duration-300',
    minimal:
      'bg-white rounded-xl border border-gray-100 hover:border-gray-200 transition-all duration-300',
    gradient:
      'bg-gradient-to-br from-white via-gray-50 to-gray-100 rounded-2xl border border-gray-200 shadow-md hover:shadow-lg transition-all duration-300',
  };
