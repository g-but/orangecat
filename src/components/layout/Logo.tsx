...
export default function Logo({ className = '' }: { className?: string }) {
  return (
    ...
    >
      ...
      <span className="text-lg sm:text-xl md:text-2xl font-bold text-tiffany-600 group-hover:text-orange-500 transition-colors whitespace-nowrap hidden sm:block">
        OrangeCat
      </span>
    </Link>
  );
