      ...
      {lightboxOpen && (
        ...
        >
          ...
          <button
            ...
            className="absolute top-4 right-4 z-[60] text-white/90 hover:text-white transition-colors p-2 rounded-full hover:bg-white/20 bg-black/40 backdrop-blur-sm"
            ...
            {publicUrls.length > 1 && (
              <>
                <button
                  ...
                  className="absolute left-2 md:left-4 top-1/2 -translate-y-1/2 text-white hover:text-white transition-all p-2 md:p-3 rounded-full hover:bg-white/20 bg-black/50 backdrop-blur-sm z-10"
                ...
                <button
                  onClick={goToNext}
                  className="absolute right-2 md:right-4 top-1/2 -translate-y-1/2 text-white hover:text-white transition-all p-2 md:p-3 rounded-full hover:bg-white/20 bg-black/50 backdrop-blur-sm z-10"
