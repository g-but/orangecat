...
const CIRCLE_TEMPLATES: CircleTemplate[] = [
  {
    ...
    useCase:
      'Perfect for families wanting to pool resources for major purchases or unexpected expenses.',
  },
  {
  ...
  return (
    <div className="space-y-6">
        ...
        {filteredTemplates.map(template => (
          ...
          >
            <div className="text-center mb-4">
              <div
                className={`w-16 h-16 ${template.color} rounded-full flex items-center justify-center mx-auto mb-3 text-2xl group-hover:scale-110 transition-transform`}
              >
                {template.icon}
              </div>
      ...
      <div className="text-center pt-8 border-t border-gray-200">
        <h4 className="text-lg font-semibold text-gray-900 mb-2">Don't see what you need?</h4>
