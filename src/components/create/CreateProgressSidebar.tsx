    ...
    <div className="fixed left-0 top-16 h-[calc(100vh-4rem)] w-80 bg-white/90 backdrop-blur-sm border-r border-gray-200 p-6 overflow-y-auto hidden lg:block">
        ...
        {steps.map((step, index) => {
          ...
          return (
            <div key={step.number} className="relative">
              {/* Connector Line */}
              {!isLast && <div className="absolute left-4 top-8 w-0.5 h-16 bg-gray-200" />}
      ...
      <div className="mt-8 p-4 bg-orange-50 rounded-lg">
        ...
        <p className="text-xs text-orange-700 leading-relaxed">
          Your progress is automatically saved as you fill out the form. You can come back anytime
