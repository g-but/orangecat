  ...
  return (
    <Card className="border-0 bg-gradient-to-br from-orange-50 via-yellow-50 to-green-50">
      <CardHeader className="text-center">
        ...
        <CardDescription className="text-lg text-gray-700">{subtitle}</CardDescription>
      </CardHeader>
      <CardContent>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-3">{bitcoinTitle}</h3>
            <p className="text-gray-600 leading-relaxed">{bitcoinDescription}</p>
          </div>
          ...
          <div className="text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-3">{aiTitle}</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-3">{openSourceTitle}</h3>
            <p className="text-gray-600 leading-relaxed">{openSourceDescription}</p>
          </div>
        </div>
        ...
        <div className="mt-8 text-center">
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-orange-100 to-green-100 px-6 py-3 rounded-full">
            ...
            <span className="font-semibold text-gray-900">
              Bitcoin × AI × Open Source = The Future
            </span>
