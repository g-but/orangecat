            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Launch a Bitcoin-powered project or initiative
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="p-4 rounded-xl border border-orange-200 bg-orange-50/60">
            ...
            <ul className="text-sm text-gray-700 space-y-2">
              <li className="flex items-start gap-2">
                <Heart className="w-4 h-4 text-orange-600 mt-0.5" /> Accept Bitcoin donations
                instantly.
              </li>
              <li className="flex items-start gap-2">
                <Users className="w-4 h-4 text-orange-600 mt-0.5" /> Rally supporters and share
                updates.
              </li>
              <li className="flex items-start gap-2">
                <Shield className="w-4 h-4 text-orange-600 mt-0.5" /> Transparent and self-custodial
                by design.
              </li>
            </ul>
            <p className="text-xs text-gray-500 mt-3">
              Looking to organize ongoing work with tasks and repos? This project interface supports
              that too!
            </p>
          </div>
        </aside>
