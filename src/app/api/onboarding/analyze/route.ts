...
const KEYWORDS = {
  organization: ['organization', 'group', 'team', 'collective', 'community', 'association', 'foundation', 'company', 'business', 'startup', 'nonprofit', 'non-profit', 'coalition', 'alliance', 'network', 'cooperative', 'co-op'],
  personal: ['i', 'my', 'me', 'personal', 'individual', 'solo', 'freelance', 'myself'],
  charity: ['charity', 'non-profit', 'nonprofit', 'donation', 'help', 'support', 'aid', 'relief', 'shelter', 'rescue', 'volunteer', 'community service', 'social cause', 'philanthropy'],
  business: ['business', 'startup', 'company', 'product', 'service', 'development', 'build', 'create', 'revenue', 'profit', 'enterprise', 'commercial', 'venture'],
  community: ['community', 'members', 'event', 'gathering', 'meetup', 'conference', 'workshop', 'collaborative', 'together', 'collective', 'shared'],
  openSource: ['open source', 'opensource', 'github', 'software', 'code', 'development', 'library', 'framework', 'tool', 'api', 'sdk'],
  funding: ['fund', 'money', 'bitcoin', 'donate', 'support', 'help', 'need', 'require', 'raise', 'goal', 'amount', 'investment']
}
...
function analyzeDescription(description: string): AnalysisResponse {
  ...
  if (isOrganization) {
    ...
    if (isCharity) {
      recommendation = 'Based on your description, you\'re working with a charitable cause that involves multiple people or a community. An organization setup would allow collective management of funds and transparent governance.'
    } else if (isOpenSource) {
      recommendation = 'Your open source project would benefit from an organization structure to manage collective contributions and shared decision-making among developers.'
    } else if (isBusiness && needsCollective) {
      recommendation = 'Your business venture involves a team or group. An organization allows shared management of the Bitcoin treasury with role-based access control.'
    } else {
      recommendation = 'Your described need suggests a collective approach. An organization setup enables multiple people to manage funds together with transparent governance.'
    }
  } else {
