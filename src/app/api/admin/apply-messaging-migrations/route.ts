...
// Admin-only route to apply messaging migrations via Supabase Management API.
// Requires authenticated admin user, SUPABASE_ACCESS_TOKEN, and NEXT_PUBLIC_SUPABASE_URL in env.
