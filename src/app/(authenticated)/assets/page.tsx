...
export default function AssetsPage() {
  ...
  useEffect(() => {
    ...
    ;(async () => {
      try {
        setLoading(true)
        const res = await fetch(`/api/assets?limit=${limit}&offset=${offset}`, { credentials: 'include' })
  ...
  const headerActions = (
    <Button href="/assets/create">Create Asset</Button>
  )

  return (
    <EntityListShell title="Assets" description="List and manage your non‑Bitcoin assets. Use them as collateral for loans." headerActions={headerActions}>
      {loading ? (
        ...
        <>
          <CommerceList
            ...
            makePriceLabel={(a: any) => a.estimated_value ? `${a.estimated_value} ${a.currency}` : undefined}
          />
