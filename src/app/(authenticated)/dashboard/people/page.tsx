      ...
      examples={[
        {
          ...
          description: 'A user passionate about Bitcoin technology and education.',
        },
        {
          title: 'Nonprofit Organizer',
          description: 'Someone organizing charitable events and projects.',
        },
        {
          title: 'Developer Contributor',
          description: 'A coder contributing to open-source Bitcoin projects.',
        },
      ]}
      renderItem={p => (
        <div>
          ...
          <div className="pt-2">
            <Button href={`/people/${p.id}`} size="sm" variant="outline">
              Open
            </Button>
          </div>
        </div>
