...
export function isValidFundingPage(data: unknown): data is FundingPage {
  return (
    ...
    typeof data === 'object' &&
    'id' in data &&
    typeof (data as FundingPage).id === 'string' &&
    'user_id' in data &&
    typeof (data as FundingPage).user_id === 'string' &&
    'title' in data &&
    typeof (data as FundingPage).title === 'string' &&
    'created_at' in data &&
    typeof (data as FundingPage).created_at === 'string'
  );
}
