...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    excerpt:
      'A straightforward explanation of how OrangeCat works, what problems it solves, and why Bitcoin wallets are becoming the new phone numbers.',
    date: '2024-12-19',
    readTime: '6 min read',
  ...
  },
  {
    ...
    excerpt:
      "Discover how we're reimagining the yellow pages for the Bitcoin age - connecting people, projects, and organizations through Bitcoin wallets instead of phone numbers.",
    date: '2024-12-19',
    readTime: '8 min read',
  ...
  },
  {
    ...
    excerpt:
      'Learn how to create your first funding page and start receiving Bitcoin funding for your projects.',
    date: '2024-03-15',
    readTime: '5 min read',
  ...
  },
  {
    ...
    excerpt:
      'Discover how Bitcoin is revolutionizing the way creators and innovators receive funding for their projects.',
    date: '2024-03-10',
    readTime: '7 min read',
  ...
  },
  {
    ...
    excerpt:
      'Read about successful projects that were funded through OrangeCat and how Bitcoin helped them achieve their goals.',
    date: '2024-03-05',
    readTime: '6 min read',
...
export const getFeaturedPost = () =>
  blogPosts.find(post => post.featured && post.published !== false);
export const getPostBySlug = (slug: string) => blogPosts.find(post => post.slug === slug);
export const getPostsByTag = (tag: string) =>
  getPublishedPosts().filter(post => post.tags.includes(tag));
