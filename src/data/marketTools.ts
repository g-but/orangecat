...
import { getRegionEmoji } from '@/services/currency';
...
export function getRegionalToolsDescription(category: string): string {
  const descriptions = {
    organizations:
      "Learning from established platforms! These organizational tools have built trust in your region and beyond. We're adding Bitcoin payments, AI-powered governance, and transparent operations 🏛️",
    events:
      "Learning from the best! These platforms have mastered event management in your region and globally. We're adding Bitcoin magic and AI-powered insights to the mix 🎟️",
    people:
      "Learning from established networks! These platforms have connected millions in your region and worldwide. We're adding Bitcoin micropayments, privacy controls, and decentralized identity 🤝",
    assets:
      "Learning from established platforms! These marketplaces have built trust in your region and beyond. We're adding Bitcoin payments, zero-waste focus, and community-driven sharing 🌱",
    funding:
      "Learning from proven platforms! These funding solutions have empowered creators globally. We're adding native Bitcoin support, lower fees, and true decentralization 🚀",
    projects:
      "Learning from the best! These development platforms have enabled millions of successful projects worldwide. We're adding Bitcoin payments, AI-powered matching, and decentralized governance 💻",
  };

  return (
    descriptions[category as keyof typeof descriptions] || 'Alternatives popular in your region'
  );
}
