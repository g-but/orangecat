...
const fieldGroups: FieldGroup[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      {
        name: 'price_per_1k_tokens_sats',
        label: 'Price per 1K Tokens (sats)',
        type: 'number',
        placeholder: '5',
        min: 0,
        colSpan: 1,
      ...
      {
        name: 'subscription_price_sats',
        label: 'Subscription Price (sats/month)',
        type: 'number',
        placeholder: '10000',
        min: 0,
        colSpan: 1,
...
const defaultValues: AIAssistantFormData = {
  ...
  price_per_message_sats: 0,
  price_per_1k_tokens_sats: 0,
