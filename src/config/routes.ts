...
export const ROUTES = {
  ...
  GROUPS: {
    LIST: ENTITY_REGISTRY['organization'].publicBasePath,
    VIEW: (slug: string) => `${ENTITY_REGISTRY['organization'].publicBasePath}/${slug}`,
  },
  ...
  DASHBOARD: {
    ...
    GROUPS: ENTITY_REGISTRY['organization'].basePath,
    GROUPS_CREATE: ENTITY_REGISTRY['organization'].createPath,
