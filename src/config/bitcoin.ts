export const BITCOIN_CONFIG = {
  // Main Bitcoin address for receiving funding
  DONATION_ADDRESS: 'bc1qgsup75ajy4rln08j0te9wpdgrf46ctx6w94xzq',

  // Network type (mainnet/testnet)
  NETWORK: 'mainnet',

  // Minimum funding amount in satoshis (0.0001 BTC)
  MIN_DONATION: 10000,

  // Maximum funding amount in satoshis (1 BTC)
  MAX_DONATION: 100000000,

  // Default funding amount in satoshis (0.001 BTC)
