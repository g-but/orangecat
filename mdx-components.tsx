...
export function useMDXComponents(components: MDXComponents): MDXComponents {
  return {
    ...
    h2: ({ children }) => (
      <h2 className="text-3xl font-bold text-gray-900 mb-6 mt-12 flex items-center">{children}</h2>
    ),
    h3: ({ children }) => (
      <h3 className="text-2xl font-semibold text-gray-900 mb-4 mt-8">{children}</h3>
    ),
    h4: ({ children }) => (
