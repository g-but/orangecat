...
describe('PeopleService', () => {
  ...
  describe('sendConnectionRequest', () => {
    it('should require authentication', async () => {
      ...
      await expect(PeopleService.sendConnectionRequest(request)).rejects.toThrow(
...
describe('OrganizationService', () => {
  ...
  describe('createOrganization', () => {
    it('should require authentication', async () => {
      ...
      await expect(OrganizationService.createOrganization(formData)).rejects.toThrow(
        'User not authenticated'
      );
    });
  });
...
describe('ProjectService', () => {
  ...
  describe('createProject', () => {
    it('should require authentication', async () => {
      ...
      await expect(ProjectService.createProject(formData)).rejects.toThrow(
        'User not authenticated'
      );
    });
  });
...
describe('Social Collaboration Integration', () => {
  ...
  it('should handle error scenarios gracefully', async () => {
    ...
    await expect(
      PeopleService.sendConnectionRequest({
        recipient_id: 'user-2',
        message: 'Hello',
      })
