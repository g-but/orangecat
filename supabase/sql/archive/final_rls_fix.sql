-- FINAL RLS POLICY FIX - Copy and paste this entire block into Supabase SQL Editor
-- This will fix the "new row violates row-level security policy" errors
...
-- Timeline events policies (use actor_id)
...
SELECT '✅ RLS policies fixed! Service creation should now work.' as status;
