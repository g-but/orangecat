-- Add is_public to group_proposals and create contracts table + RLS (retry)
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public' AND tablename = 'group_proposals' 
      AND policyname = 'Public can view public proposals'
  ) THEN
