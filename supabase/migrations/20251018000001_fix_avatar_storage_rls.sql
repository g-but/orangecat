...
-- This migration corrects the path matching to align with actual upload paths
-- File paths are: {userId}/avatar_{timestamp}.{ext} (no 'avatars/' prefix in path)
...
-- Add helpful comment
COMMENT ON TABLE storage.objects IS 'Storage objects with RLS policies for profile uploads - updated 2025-10-18';
