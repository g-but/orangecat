...
-- This migration handles the duplicate key error by using ON CONFLICT
-- and adds the contact_email column if it doesn't exist

BEGIN;

-- Try to insert the migration record, but ignore if it already exists
INSERT INTO supabase_migrations.schema_migrations(version, name, statements)
VALUES ('20250124', 'remove_non_mvp_entities', '')
