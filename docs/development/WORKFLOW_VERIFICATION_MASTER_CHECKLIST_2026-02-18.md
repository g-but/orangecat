...
- ☑ P0 matrix runs green in CI with required secrets — [GitHub Actions run 28722171024](https://github.com/catomean/orangecat/actions/runs/28722171024) / commit `d3e1bbe6`: **11/11 passed** (2026-07-05)
