...
**Services:**
9. `src/services/featured.ts` (5 occurrences)
10. `src/services/search/queries.ts`
11. `src/services/performance/database-optimizer.ts`
12. `src/domain/projects/service.ts`
13. `src/stores/projectStore.ts`
14. `src/components/create/CreateCampaignForm.tsx`
15. `src/scripts/setup-subscription-funding.js` (3 occurrences)
...
**Pages:**
4. `src/app/profiles/[username]/page.tsx` - 8 queries
5. `src/app/projects/[id]/page.tsx` - 4 queries
