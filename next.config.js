...
const nextConfig = {
  ...
  // Note: serverExternalPackages removed entirely to fix webpack bundling issues
  // Let webpack bundle all packages including Supabase for proper module resolution
