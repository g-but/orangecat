...
// blankNonCode moved to scripts/lib/blank-non-code.mjs — check-currency-units.mjs
// needs the identical parse, and a second hand-rolled copy is how the naive
// `//`-only version comes back.
