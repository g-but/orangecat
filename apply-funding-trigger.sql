...
-- URL: https://supabase.com/dashboard/project/ohkueislstxomdjavyhs/sql/new
...
COMMENT ON FUNCTION sync_project_funding() IS
  'Automatically maintains projects.raised_amount and contributor_count based on confirmed transactions. ' ||
  'Handles INSERT, UPDATE (status changes), and DELETE operations atomically.';
...
WHERE trigger_name = 'transaction_funding_sync';
